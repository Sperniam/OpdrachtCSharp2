public class VerlofPeriode
{
    ...
    public static readonly VerlofPeriode[] AllePeriodes =
    {
        new VerlofPeriode("ZomerVakantie", new DateOnly(2025, 7, 1), new DateOnly(2025, 7, 31)),
        new VerlofPeriode("KerstVakantie", new DateOnly(2025, 12, 25), new DateOnly(2026, 1, 1))
    };
